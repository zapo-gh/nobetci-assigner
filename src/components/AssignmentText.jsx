...
export default function AssignmentText({
  ...
  // Yazdırma için: görevlendirmeleri iki sütuna dengeli böl
  // Saat numaraları arasındaki en büyük boşluğu orta noktaya en yakın yerde kullanarak böler.
  // Örnek: 1-2-4-5-7-8-9 saatleri → sol: 1-2-4-5, sağ: 7-8-9
